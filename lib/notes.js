...
function addNote(notesArray, newData) {
  // For each note that was previously 'currentlyPosted = true', set it to false so we can set it to true for the most recent note
  // that was actually recentlyPosted
...
// This executes when we visit the notes/preview/ endpoint so that we can view what we click vs. showing the most recently added response
